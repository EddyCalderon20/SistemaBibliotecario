...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         * Estudiante juan=new Estudiante(); Estudiante pedro=new
         * Estudiante(30224,100.0); juan.muestraDatos(); pedro.muestraDatos();
         */
        ...
        if (en == 0) {
            ...
            do {
                ...
                String valor;
                System.out.println("*Ingreso de libros exitoso*");
    ...
    public static void prestar(ArrayList<Libro> Lbs, ArrayList<Prestamo> prestamos,ArrayList<String> carrito) {
        ...
        for (Libro lb : Lbs) {
            if (codigo.equals(lb.getCodigo())&&!(lb.isPrestamo())) {
                ...
                System.out.println("No puede prestar el Libro");
            }
        }
